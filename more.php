...
.wrapper .main_content .info{margin:20px;color:#717171;line-height:25px;}
.wrapper .main_content .table{margin:2%;width:50%;text-align:center;color:#717171;}
.wrapper .main_content .table table{width:100%;}
.wrapper .main_content .table table td{width:50%;padding:10px;}
            ...
            <div class="table">
                <table>
                    <tr>
                        <td>
                            <a href="card.php">
                                <img src="https://bnd-s3-bucket.s3.ap-southeast-1.amazonaws.com/ICONS/BANK.png" alt="">
                                <p>Card Management</p>
                            </a>
                        </td>
                        <td>
                            <a href="piggy.php">
                                <img src="https://bnd-s3-bucket.s3.ap-southeast-1.amazonaws.com/ICONS/PIGGY%20BANK%202.png" alt="">
                                <p>BND Piggy Bank</p>
                            </a>
                        </td>
                    </tr>
